...
public class JourneyCapConsumerServiceSelector : ConsumerServiceSelector, ISingletonDependency
{
    ...
    /// </summary>
    public JourneyCapConsumerServiceSelector(IServiceProvider serviceProvider, IOptions<AbpDistributedEventBusOptions> distributedEventBusOptions) : base(serviceProvider)
    {

...
public class JourneyCapDistributedEventBus : EventBusBase, IDistributedEventBus, ISingletonDependency
{
    ...
    public JourneyCapDistributedEventBus(IServiceScopeFactory serviceScopeFactory,
        ...
        bool useOutbox = true)
    {
        ...
        {
            if (UnitOfWorkManager.Current is not JourneyCapUnitOfWork capUnitOfWork || capUnitOfWork.CapTransaction is null)
            {

...
namespace EHR.Journey.Cli.Github;

public class JourneyManager : ITransientDependency, IJourneyManager
{
    private readonly JourneyCliOptions _cliOptions;
    private readonly IHttpClientFactory _httpClientFactory;

    public JourneyManager(IOptions<JourneyCliOptions> options, IHttpClientFactory httpClientFactory)
    {

    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        if (CultureName.IsNullOrWhiteSpace())
        {
            yield return new ValidationResult(
                localization[JourneyLocalizationErrorCodes.ErrorCode100003, nameof(CultureName)],
        ...
        {
            yield return new ValidationResult(
                localization[JourneyLocalizationErrorCodes.ErrorCode100003, nameof(ResourceName)],
        ...
        {
            yield return new ValidationResult(
                localization[JourneyLocalizationErrorCodes.ErrorCode100003, nameof(Value)],
                new[] { nameof(Value) }
            );
        }
    }

...
{
    public class JourneyDbMigrationService : ITransientDependency
    {
        private ILogger<JourneyDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IJourneyDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public JourneyDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IJourneyDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<JourneyDbMigrationService>.Instance;
        }

...
public class JourneySharedHostingMicroserviceModule : AbpModule
{
    ...
    private void ConfigureAbpExceptions(ServiceConfigurationContext context)
    {
        ...
        (
            options =>
            {
                options.Filters.Add(typeof(JourneyExceptionFilter));
                options.Filters.Add(typeof(JourneyResultFilter));
            }
        );
    }

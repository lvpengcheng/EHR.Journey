using EHR.Journey.DataDictionaryManagement.DataDictionaries.Aggregates;
using EHR.Journey.LanguageManagement.EntityFrameworkCore;
using EHR.Journey.LanguageManagement.Languages.Aggregates;
using EHR.Journey.LanguageManagement.LanguageTexts.Aggregates;
using EHR.Journey.NotificationManagement.Notifications.Aggregates;
...
namespace EHR.Journey.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See JourneyMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class JourneyDbContext : AbpDbContext<JourneyDbContext>, IJourneyDbContext,

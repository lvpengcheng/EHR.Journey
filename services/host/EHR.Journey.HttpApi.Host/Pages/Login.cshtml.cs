...
using EHR.Journey.BasicManagement.ConfigurationOptions;
using EHR.Journey.BasicManagement.Users;
    ...
    public class Login : PageModel
    {
        ...
        public async Task OnPost()
        {
            ...
            try
            {
                ...
                // 设置cookies domain
                //options.Domain = "Journey.cn";


                var result = await _accountAppService.LoginAsync(new LoginInput()
                { Name = userName, Password = password });
                Response.Cookies.Append(JourneyHttpApiHostConst.DefaultCookieName,
